// Nigerian banks + Paystack transfer codes.
// Source: Paystack banks API (GET /bank?country=nigeria) — the codes here are
// exactly what Paystack expects for transfer recipients, so withdrawals resolve.
// Regenerate with: curl https://api.paystack.co/bank?country=nigeria -H "Authorization: Bearer $KEY"
...
export const BANKS: Bank[] = [
  ...
  { name: 'Adamawa Mortgage Bank Limited', code: '90102' },
  ...
  { name: 'Cooperative Mortgage Bank', code: '90089' },
  ...
  { name: 'First Option MFB', code: '50934' },
  ...
  { name: 'INEBA GOGO MFB', code: '51462' },
  ...
  { name: 'Kebbi Homes Savings and Loans Limited', code: '90028' },
  ...
  { name: 'Mayfresh Mortgage Bank', code: '90003' },
  { name: 'Mega Microfinance Bank', code: '50570' },
  { name: 'Michael Okpara UniAgric Microfinance Bank', code: 'MFB51116M' },
  ...
  { name: 'Sycamore Microfinance Bank', code: '51056' },
